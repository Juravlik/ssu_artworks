...
parser.add_argument('--config', action="store", dest="config",
                    default=os.path.join(config_dir, "train_regression_after_classifier.yaml"),
                    type=str)
...
def main(train_config: dict):
    ...
    scheduler = object_from_dict(train_config.scheduler, optimizer=optimizer)
    ...
    model = object_from_dict({
        'type': model_checkpoint['config']['model']['type'],
        'path_to_searchart_model': model_checkpoint['config']['model']['path_to_searchart_model'],
